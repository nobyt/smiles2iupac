...
@pytest.mark.parametrize("smiles,expected", [
    ...
    ("CC1Cc2ccccc2C1=O",   "2-methyl-2,3-dihydroinden-1-one"),
    ("CC1CC(=O)c2ccccc21", "3-methyl-2,3-dihydroinden-1-one"),
    ("Cc1cccc2c1CCC2=O",   "4-methyl-2,3-dihydroinden-1-one"),
    ("Cc1ccc2c(c1)CCC2=O", "5-methyl-2,3-dihydroinden-1-one"),
    ("Cc1ccc2c(c1)C(=O)CC2","6-methyl-2,3-dihydroinden-1-one"),
    ("Cc1cccc2c1C(=O)CC2", "7-methyl-2,3-dihydroinden-1-one"),
