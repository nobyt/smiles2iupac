...
@pytest.mark.parametrize("smiles,expected", [
    ("[H]Oc1cc2[nH]nnc2nn1",         "[1,2,3]triazolo[4,5-c]pyridazin-6(1H)-one"),
    ("[H]Sc1cc2[nH]nnc2nn1",         "[1,2,3]triazolo[4,5-c]pyridazin-6(1H)-thione"),
    ...
    ("[H]Oc1nnc2[nH]nnc2n1",         "[1,2,3]triazolo[4,5-e][1,2,4]triazin-6(1H)-one"),
    ("[H]Sc1nnc2[nH]nnc2n1",         "[1,2,3]triazolo[4,5-e][1,2,4]triazin-6(1H)-thione"),
    ("[H]Oc1cc2nn[nH]c2nn1",         "[1,2,3]triazolo[5,4-c]pyridazin-6(1H)-one"),
    ("[H]Sc1cc2nn[nH]c2nn1",         "[1,2,3]triazolo[5,4-c]pyridazin-6(1H)-thione"),
    ("[H]Oc1nccc2nn[nH]c12",         "[1,2,3]triazolo[5,4-c]pyridin-4(1H)-one"),
    ("[H]Sc1nccc2nn[nH]c12",         "[1,2,3]triazolo[5,4-c]pyridin-4(1H)-thione"),
    ("[H]Oc1cc2nn[nH]c2cn1",         "[1,2,3]triazolo[5,4-c]pyridin-6(1H)-one"),
    ("[H]Sc1cc2nn[nH]c2cn1",         "[1,2,3]triazolo[5,4-c]pyridin-6(1H)-thione"),
    ...
    ("[H]Oc1nnc2nn[nH]c2n1",         "[1,2,3]triazolo[5,4-e][1,2,4]triazin-6(1H)-one"),
    ("[H]Sc1nnc2nn[nH]c2n1",         "[1,2,3]triazolo[5,4-e][1,2,4]triazin-6(1H)-thione"),
