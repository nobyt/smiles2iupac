...
@pytest.mark.parametrize("smiles,expected", [
    ...
    ("CC1C(=O)Nc2ccccc21",  "3-methyl-1,3-dihydroindol-2-one"),
    ("Cc1cccc2c1CC(=O)N2",  "4-methyl-1,3-dihydroindol-2-one"),
    ("Cc1ccc2c(c1)CC(=O)N2", "5-methyl-1,3-dihydroindol-2-one"),
    ("Cc1ccc2c(c1)NC(=O)C2", "6-methyl-1,3-dihydroindol-2-one"),
    ("Cc1cccc2c1NC(=O)C2",  "7-methyl-1,3-dihydroindol-2-one"),
