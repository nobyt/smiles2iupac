...
@pytest.mark.parametrize("smiles,expected", [
    ...
    ("O=c1occc2c(C)cccc12", "5-methylisochromen-1-one"),
    ("O=c1occc2cc(C)ccc12", "6-methylisochromen-1-one"),
    ("O=c1occc2ccc(C)cc12", "7-methylisochromen-1-one"),
    ("O=c1occc2cccc(C)c12", "8-methylisochromen-1-one"),
