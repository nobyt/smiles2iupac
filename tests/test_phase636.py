...
1,2,3,4-tetrahydro-1,5/1,8-naphthyridine (symmetric: 1,2,3,4 prefix has lower locants than 5,6,7,8),
5,6,7,8-tetrahydro-1,6/1,7-naphthyridine, and
1,2,3,4-tetrahydro-1,6/1,7-naphthyridine (IUPAC 2013).
"""
...
@pytest.mark.parametrize("smiles,expected", [
    ...
    # 1,2,3,4-tetrahydro-1,5-naphthyridine: N(1,H)-C(2)-C(3)-C(4)-C(4a,junc)-C(8a,junc)-C(8)-C(7)-C(6)-N(5,None)
    ("CN1CCCc2ncccc21",     "1-methyl-1,2,3,4-tetrahydro-1,5-naphthyridine"),
    ("CC1CCc2ncccc2N1",     "2-methyl-1,2,3,4-tetrahydro-1,5-naphthyridine"),
    ("CC1CNc2cccnc2C1",     "3-methyl-1,2,3,4-tetrahydro-1,5-naphthyridine"),
    ("CC1CCNc2cccnc21",     "4-methyl-1,2,3,4-tetrahydro-1,5-naphthyridine"),
    ("Cc1ccc2c(n1)CCCN2",   "6-methyl-1,2,3,4-tetrahydro-1,5-naphthyridine"),
    ("Cc1cnc2c(c1)NCCC2",   "7-methyl-1,2,3,4-tetrahydro-1,5-naphthyridine"),
    ("Cc1ccnc2c1NCCC2",     "8-methyl-1,2,3,4-tetrahydro-1,5-naphthyridine"),
    ...
    # 1,2,3,4-tetrahydro-1,8-naphthyridine: N(1,H)-C(2)-C(3)-C(4)-C(4a,junc)-C(8a,junc)-C(5)-C(6)-C(7)-N(8,None)
    ("CN1CCCc2cccnc21",     "1-methyl-1,2,3,4-tetrahydro-1,8-naphthyridine"),
    ("CC1CCc2cccnc2N1",     "2-methyl-1,2,3,4-tetrahydro-1,8-naphthyridine"),
    ("CC1CNc2ncccc2C1",     "3-methyl-1,2,3,4-tetrahydro-1,8-naphthyridine"),
    ("CC1CCNc2ncccc21",     "4-methyl-1,2,3,4-tetrahydro-1,8-naphthyridine"),
    ("Cc1ccnc2c1CCCN2",     "5-methyl-1,2,3,4-tetrahydro-1,8-naphthyridine"),
    ("Cc1cnc2c(c1)CCCN2",   "6-methyl-1,2,3,4-tetrahydro-1,8-naphthyridine"),
    ("Cc1ccc2c(n1)NCCC2",   "7-methyl-1,2,3,4-tetrahydro-1,8-naphthyridine"),
