"""Phase 693: methyl derivatives of benz[a]acridine and benz[c]acridine."""
import pytest
from smiles2iupac import smiles_to_iupac


@pytest.mark.parametrize("smiles,expected", [
    # benz[a]acridine (N at 10; positions 1-9, 11-12 are CH)
    ...
    # benz[c]acridine (N at 7; positions 1-6, 8-12 are CH)
...
def test_phase693(smiles, expected):
