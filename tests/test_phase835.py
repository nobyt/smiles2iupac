...
@pytest.mark.parametrize("smiles,expected", [
    ...
    ("[H]Oc1nc2cnncc2[nH]1",         "imidazo[4,5-d]pyridazin-2(1H)-one"),
    ("[H]Sc1nc2cnncc2[nH]1",         "imidazo[4,5-d]pyridazin-2(1H)-thione"),
    ("[H]Oc1nncc2[nH]cnc12",         "imidazo[4,5-d]pyridazin-4(1H)-one"),
    ("[H]Sc1nncc2[nH]cnc12",         "imidazo[4,5-d]pyridazin-4(1H)-thione"),
    ...
    ("[H]Oc1nnc2nc[nH]c2n1",         "imidazo[5,4-e][1,2,4]triazin-3(1H)-one"),
    ("[H]Sc1nnc2nc[nH]c2n1",         "imidazo[5,4-e][1,2,4]triazin-3(1H)-thione"),
    ("[H]Oc1nc2nncnc2[nH]1",         "imidazo[5,4-e][1,2,4]triazin-6(1H)-one"),
    ("[H]Sc1nc2nncnc2[nH]1",         "imidazo[5,4-e][1,2,4]triazin-6(1H)-thione"),
