...
@pytest.mark.parametrize("smiles,expected", [
    ("[H]Oc1n[nH]c2nnccc12",         "pyrazolo[5,4-c]pyridazin-3(1H)-one"),
    ("[H]Sc1n[nH]c2nnccc12",         "pyrazolo[5,4-c]pyridazin-3(1H)-thione"),
    ...
    ("[H]Oc1n[nH]c2nnncc12",         "pyrazolo[5,4-d][1,2,3]triazin-5(1H)-one"),
    ("[H]Sc1n[nH]c2nnncc12",         "pyrazolo[5,4-d][1,2,3]triazin-5(1H)-thione"),
