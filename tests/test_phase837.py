...
@pytest.mark.parametrize("smiles,expected", [
    ...
    ("[H]Oc1nnnc2n[nH]nc12",         "2H-[1,2,3]triazolo[4,5-d][1,2,3]triazin-7(2H)-one"),
    ("[H]Sc1nnnc2n[nH]nc12",         "2H-[1,2,3]triazolo[4,5-d][1,2,3]triazin-7(2H)-thione"),
    ("[H]Oc1ncc2n[nH]nc2n1",         "2H-[1,2,3]triazolo[4,5-d]pyrimidin-5(2H)-one"),
    ("[H]Sc1ncc2n[nH]nc2n1",         "2H-[1,2,3]triazolo[4,5-d]pyrimidin-5(2H)-thione"),
    ("[H]Oc1ncnc2n[nH]nc12",         "2H-[1,2,3]triazolo[4,5-d]pyrimidin-7(2H)-one"),
    ("[H]Sc1ncnc2n[nH]nc12",         "2H-[1,2,3]triazolo[4,5-d]pyrimidin-7(2H)-thione"),
    ...
    ("[H]Oc1cnc2n[nH]nc2n1",         "2H-[1,2,3]triazolo[4,5-e]pyrazin-5(2H)-one"),
    ("[H]Sc1cnc2n[nH]nc2n1",         "2H-[1,2,3]triazolo[4,5-e]pyrazin-5(2H)-thione"),
