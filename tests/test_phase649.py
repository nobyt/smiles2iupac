...
@pytest.mark.parametrize("smiles,expected", [
    ...
    # 1,2-dihydro-1,8-naphthyridine parent + methyl derivatives (Phase 658 fix; N8 arom → no 8-methyl)
    ("C1=Cc2cccnc2NC1", "1,2-dihydro-1,8-naphthyridine"),
    ("CN1CC=Cc2cccnc21", "1-methyl-1,2-dihydro-1,8-naphthyridine"),
    ("CC1C=Cc2cccnc2N1", "2-methyl-1,2-dihydro-1,8-naphthyridine"),
    ("CC1=Cc2cccnc2NC1", "3-methyl-1,2-dihydro-1,8-naphthyridine"),
    ("CC1=CCNc2ncccc21", "4-methyl-1,2-dihydro-1,8-naphthyridine"),
    ("Cc1ccnc2c1C=CCN2", "5-methyl-1,2-dihydro-1,8-naphthyridine"),
    ("Cc1cnc2c(c1)C=CCN2", "6-methyl-1,2-dihydro-1,8-naphthyridine"),
    ("Cc1ccc2c(n1)NCC=C2", "7-methyl-1,2-dihydro-1,8-naphthyridine"),
