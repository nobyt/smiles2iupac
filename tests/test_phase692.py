"""Phase 692: methyl derivatives of benzo[c/f/g/h]cinnoline, benzo[f/g]quinoxaline, benzo[f/g]phthalazine."""
import pytest
from smiles2iupac import smiles_to_iupac


@pytest.mark.parametrize("smiles,expected", [
    # benzo[c]cinnoline (N at 5,6; C2v: 1=10, 2=9, 3=8, 4=7 → 4 unique)
    ...
    # benzo[f]cinnoline (N at 4,5; positions 1-3, 6-10 are CH)
    ...
    # benzo[h]cinnoline (N at 9,10; positions 1-8 are CH)
    ...
    # benzo[g]cinnoline (N at 7,8; positions 1-6, 9-10 are CH)
    ...
    # benzo[f]quinoxaline (N at 2,5; positions 1, 3-4, 6-10 are CH)
    ...
    # benzo[g]quinoxaline (N at 5,8; C2v: 1=4, 2=3, 6=7, 9=10 → 4 unique)
    ...
    # benzo[g]phthalazine (N at 6,7; C2v: 1=4, 2=3, 5=8, 9=10 → 4 unique)
    ...
    # benzo[f]phthalazine (N at 3,4; positions 1-2, 5-10 are CH)
...
def test_phase692(smiles, expected):
