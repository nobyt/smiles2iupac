...
@pytest.mark.parametrize("smiles,expected", [
    ...
    ("O=C1C(C)Cc2ccccc21", "2-methyl-2,3-dihydroinden-1-one"),
    ("O=C1CC(C)c2ccccc21", "3-methyl-2,3-dihydroinden-1-one"),
    ("O=C1CCc2c(C)cccc21", "4-methyl-2,3-dihydroinden-1-one"),
    ("O=C1CCc2cc(C)ccc21", "5-methyl-2,3-dihydroinden-1-one"),
    ("O=C1CCc2ccc(C)cc21", "6-methyl-2,3-dihydroinden-1-one"),
    ("O=C1CCc2cccc(C)c21", "7-methyl-2,3-dihydroinden-1-one"),
    ...
    ("O=C1Cc2ccccc2N(C)1", "1-methyl-1,3-dihydroindol-2-one"),
    ("O=C1C(C)c2ccccc2N1", "3-methyl-1,3-dihydroindol-2-one"),
    ("O=C1Cc2c(C)cccc2N1", "4-methyl-1,3-dihydroindol-2-one"),
    ("O=C1Cc2cc(C)ccc2N1", "5-methyl-1,3-dihydroindol-2-one"),
    ("O=C1Cc2ccc(C)cc2N1", "6-methyl-1,3-dihydroindol-2-one"),
    ("O=C1Cc2cccc(C)c2N1", "7-methyl-1,3-dihydroindol-2-one"),
